package com.flight.travelmyswiftpay.providers.woocommerce.model.orders;
...
public class Order {
    ...
    public Date getDateCreated() {
        try {
            return ORDER_DATE_FORMAT.parse(dateCreated);
    ...
    public Date getDateModified() {
        try {
            return ORDER_DATE_FORMAT.parse(dateModified);
        } catch (ParseException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public Date getDateCompleted() {
        try {
            return ORDER_DATE_FORMAT.parse(dateCompleted);
        } catch (ParseException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public Date getDatePaid() {
        try {
            return ORDER_DATE_FORMAT.parse(datePaid);
        } catch (ParseException e) {
            e.printStackTrace();
            return null;
        }
