package com.flight.travelmyswiftpay.providers.videos.ui;
...
import com.flight.travelmyswiftpay.providers.videos.VideosAdapter;
import com.flight.travelmyswiftpay.providers.videos.api.VideoProvider;
import com.flight.travelmyswiftpay.providers.videos.api.VideosCallback;
import com.flight.travelmyswiftpay.providers.videos.api.VimeoClient;
import com.flight.travelmyswiftpay.providers.videos.api.WordpressClient;
import com.flight.travelmyswiftpay.providers.videos.api.YoutubeClient;
...
public class VideosFragment extends Fragment implements InfiniteRecyclerViewAdapter.LoadMoreListener, VideosCallback {
        ...
        OnItemClickListener listener = (new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (videoApiClient.isYoutubeLive()) {
                    YoutubeClient.playVideo(video, mAct);
                } else {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (providerString.equals(Provider.YOUTUBE)) {
            videoApiClient = new YoutubeClient(getPassedData(), mAct, this);
        } else if (providerString.equals(Provider.VIMEO)){
            videoApiClient = new VimeoClient(getPassedData(), mAct, this);
        } else {
