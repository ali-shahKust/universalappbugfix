...
import com.flight.travelmyswiftpay.providers.woocommerce.model.ViewItem;
...
public class ProductsAdapter extends InfiniteRecyclerViewAdapter {
    ...
    private List<ViewItem> headersList;
    ...
    public ProductsAdapter(Context mContext, List<Product> productsList, LoadMoreListener listener) {
