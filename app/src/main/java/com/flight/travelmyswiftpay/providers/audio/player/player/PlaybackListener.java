...
class PlaybackListener extends BroadcastReceiver {
    ...
    /**
     * package private, action used when the duration changed.
     */
    ...
    /**
     * package private, extra key for passing the duration of a track in milli
     */
        ...
        if (intent != null) {
            switch (intent.getAction()) {
                ...
                case ACTION_ON_PROGRESS_CHANGED:
                    ...
                    break;
                case ACTION_ON_DURATION_CHANGED:
    ...
    /**
     * Called when the duration of a track is changed
     *
     * @param duration new duration in ms
     */
    protected void onDurationChanged(long duration) {
