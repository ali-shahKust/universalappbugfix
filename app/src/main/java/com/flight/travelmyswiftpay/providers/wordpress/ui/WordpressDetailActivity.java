package com.flight.travelmyswiftpay.providers.wordpress.ui;
...
import com.flight.travelmyswiftpay.comments.CommentsActivity;
...
import com.flight.travelmyswiftpay.providers.wordpress.WordpressListAdapter;
import com.flight.travelmyswiftpay.providers.wordpress.api.JsonApiPostLoader;
import com.flight.travelmyswiftpay.providers.wordpress.api.RestApiPostLoader;
import com.flight.travelmyswiftpay.providers.wordpress.api.WordpressGetTaskInfo;
import com.flight.travelmyswiftpay.providers.wordpress.api.WordpressPostsLoader;
import com.flight.travelmyswiftpay.providers.wordpress.api.providers.JetPackProvider;
import com.flight.travelmyswiftpay.providers.wordpress.api.providers.RestApiProvider;
    ...
    private void configureFavoritesButton(){
        ...
        btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (mDbHelper.checkEvent(post.getTitle(), post, Provider.WORDPRESS)) {
                    // Item is new
                    mDbHelper.addFavorite(post.getTitle(), post, Provider.WORDPRESS);
                    Toast toast = Toast
                            .makeText(
