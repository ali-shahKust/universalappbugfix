...
import com.flight.travelmyswiftpay.providers.videos.player.YouTubePlayerActivity;
...
public class YoutubeClient implements VideoProvider {
    ...
    public void requestVideos(String pageToken, String searchQuery) {
        ...
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                serverKey = activityReference.get().getResources().getString(R.string.google_server_key);
