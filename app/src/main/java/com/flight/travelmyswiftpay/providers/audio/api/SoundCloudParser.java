	...
	public static TrackObject parsingTrackObject(JSONObject mJsonObject, SoundCloudClient api){
		if(mJsonObject!=null){
			try {
				...
				long playCount = (mJsonObject.has("playback_count")) ? mJsonObject.getLong("playback_count") : 0;
				long favoritingsCount = (mJsonObject.has("favoritings_count")) ? mJsonObject.getLong("favoritings_count") : 0;
				long commentCount = (mJsonObject.has("comment_count")) ? mJsonObject.getLong("comment_count") : 0;
