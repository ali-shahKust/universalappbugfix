package com.flight.travelmyswiftpay.providers.audio.player.player;
...
import com.flight.travelmyswiftpay.providers.audio.helpers.SoundCloudArtworkHelper;
import com.flight.travelmyswiftpay.providers.audio.player.media.MediaSessionWrapper;
...
public class PlaybackService extends Service implements MediaPlayer.OnErrorListener,
    ...
    public static void registerListener(Context context, PlaybackListener listener) {
        ...
        filter.addAction(PlaybackListener.ACTION_ON_DURATION_CHANGED);
    ...
    public void onCreate() {
        ...
        mWifiLock = ((WifiManager) getBaseContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE))
    ...
    private void resume() {
        if (mIsPaused) {
            ...
            if (requestAudioFocus(mAudioManager)
    ...
    private void nextTrack() {
        if (mPlayerPlaylist.isEmpty()) return;
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if(track.getDuration() == 0) {
            ...
            Intent i = new Intent(PlaybackListener.ACTION_ON_DURATION_CHANGED);
            i.putExtra(PlaybackListener.EXTRA_KEY_DURATION
