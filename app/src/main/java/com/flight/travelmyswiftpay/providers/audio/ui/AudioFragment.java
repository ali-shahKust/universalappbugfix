package com.flight.travelmyswiftpay.providers.audio.ui;
...
import com.flight.travelmyswiftpay.MainActivity;
import com.flight.travelmyswiftpay.R;
import com.flight.travelmyswiftpay.inherit.BackPressFragment;
import com.flight.travelmyswiftpay.inherit.CollapseControllingFragment;
import com.flight.travelmyswiftpay.providers.Provider;
import com.flight.travelmyswiftpay.providers.audio.TracksAdapter;
import com.flight.travelmyswiftpay.providers.audio.api.SoundCloudClient;
import com.flight.travelmyswiftpay.providers.audio.api.WordpressClient;
import com.flight.travelmyswiftpay.providers.audio.api.object.TrackObject;
import com.flight.travelmyswiftpay.providers.audio.helpers.EndlessRecyclerOnScrollListener;
import com.flight.travelmyswiftpay.providers.audio.player.player.CheerleaderPlayer;
import com.flight.travelmyswiftpay.providers.audio.player.player.CheerleaderPlaylistListener;
import com.flight.travelmyswiftpay.providers.audio.ui.views.PlaybackView;
import com.flight.travelmyswiftpay.providers.audio.ui.views.TrackView;
...
import com.flight.travelmyswiftpay.util.ThemeUtils;
...
public class AudioFragment extends Fragment implements
    ...
    private CheerleaderPlayer initPlayer(){
        String[] arguments = getArguments().getStringArray(MainActivity.FRAGMENT_DATA);
        Bundle bundle = new Bundle();
        bundle.putStringArray(MainActivity.FRAGMENT_DATA, arguments);
