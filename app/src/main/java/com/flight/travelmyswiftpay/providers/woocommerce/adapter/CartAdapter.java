package com.flight.travelmyswiftpay.providers.woocommerce.adapter;
...
import com.flight.travelmyswiftpay.providers.woocommerce.checkout.Cart;
import com.flight.travelmyswiftpay.providers.woocommerce.checkout.CartAssistant;
import com.flight.travelmyswiftpay.providers.woocommerce.checkout.CartProduct;
...
import com.flight.travelmyswiftpay.providers.woocommerce.ui.ProductActivity;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder>{
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        TextView productName, productPrice, productPriceRegular, productQuantity, productDetails;
        ImageView productImage;
        TextView overflowDelete, overflowEdit;
    ...
    public void onBindViewHolder(final CartAdapter.MyViewHolder holder, int position) {
        ...
        holder.productQuantity.setText(String.format(mContext.getString(R.string.quantity), cartProduct.getQuantity()).trim());
