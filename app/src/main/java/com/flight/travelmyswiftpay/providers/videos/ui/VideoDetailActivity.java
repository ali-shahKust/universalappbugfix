...
import com.flight.travelmyswiftpay.providers.videos.PicassoVideoThumbnailHandler;
...
public class VideoDetailActivity extends DetailActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnPlay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if (provider.equals(Provider.YOUTUBE))
					YoutubeClient.playVideo(video, VideoDetailActivity.this);
		...
		btnComment.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				if (provider.equals(Provider.YOUTUBE))
					YoutubeClient.openComments(video, VideoDetailActivity.this);
				else
