...
public class AudioPlayerActivity extends AppCompatActivity implements MediaController.MediaPlayerControl {
    ...
    private com.flight.travelmyswiftpay.attachmentviewer.MusicService MusicService;
    ...
    protected void onResume() {
        super.onResume();
        //bind to service
        MusicServiceIntent = new Intent(this, com.flight.travelmyswiftpay.attachmentviewer.MusicService.class);
    ...
    private final class MusicServiceServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder baBinder) {
            ...
            MusicService = ((com.flight.travelmyswiftpay.attachmentviewer.MusicService.MusicServiceBinder) baBinder).getService();
