package flight.sherdle.universal.providers.wordpress.api.providers;

import android.text.Html;

import flight.sherdle.universal.Config;
import flight.sherdle.universal.attachmentviewer.model.MediaAttachment;
import flight.sherdle.universal.providers.wordpress.CategoryItem;
...
import flight.sherdle.universal.providers.wordpress.api.WordpressCategoriesTask;
import flight.sherdle.universal.providers.wordpress.api.WordpressGetTaskInfo;
import flight.sherdle.universal.providers.wordpress.api.WordpressPostsTask;
    ...
    public ArrayList<CategoryItem> getCategories(WordpressGetTaskInfo info) {
        ...
        try {
            ...
            for (int i = 0; i < categories.length(); i++) {
                ...
                CategoryItem item = new CategoryItem(category.getString("slug"), category.getString("title"), category.getInt("post_count"));
                result.add(item);
            }
