...
public class AudioPlayerActivity extends AppCompatActivity implements MediaController.MediaPlayerControl {
    ...
    private flight.sherdle.universal.attachmentviewer.MusicService MusicService;
    ...
    protected void onResume() {
        super.onResume();
        //bind to service
        MusicServiceIntent = new Intent(this, flight.sherdle.universal.attachmentviewer.MusicService.class);
    ...
    private final class MusicServiceServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder baBinder) {
            ...
            MusicService = ((flight.sherdle.universal.attachmentviewer.MusicService.MusicServiceBinder) baBinder).getService();
